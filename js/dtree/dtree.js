...
function NodeTree(id, pid, name, url, title, target, icon, iconOpen, open) {
...
dTree.prototype.add = function (id, pid, name, url, title, target, icon, iconOpen, open) {
    ...
    this.aNodes[this.aNodes.length] = new NodeTree(id, pid, name, url, title, target, icon, iconOpen, open);
