...
<ol class="breadcrumb page-breadcrumb">
    ...
    <li><a class="xhr dest_subcontent-element active" href="/ekeuanganpts/index.php?mod=rencana_pencairan_dana&amp;sub=rencanaPencairanDana&amp;act=view&amp;typ=html">Rencana Pencairan Dana</a></li>
...
<div class="page-header">
	<h1>
        <span class="text-muted font-weight-light">
			<i class="page-header-icon "></i> Rencana Pencairan Dana
        </span>
    </h1>
</div>
...
<div class="panel panel-default">
		...
		<div class="panel-body">
			  <form method="POST" action="/ekeuanganpts/index.php?mod=rencana_pencairan_dana&amp;sub=rencanaPencairanDana&amp;act=view&amp;typ=html" id="filterbox" name="filterbox" class="xhr_simple_form dest_subcontent-element form-horizontal">
					  <div class="row">
                                                   ...
                                                   <div class="input-group"> 
                                                    ...
                                                    <input type="text" name="unit_nama" id="txt_unit" readonly="readonly" class="form-control" size="35" value="UNIVERSITAS">
                                                       <div class="input-group-btn">
                                                          <button class="btn btn-default" type="button" onclick="javascript:bukaPopupUnitKerja('/ekeuanganpts/index.php?mod=rencana_pencairan_dana&amp;sub=PopupUnitKerja&amp;act=view&amp;typ=html')">
...
<script>if(window.ButtonAccess){ var ba = new ButtonAccess(""); ba.removeButton();}
		...
		<div class="btn-group pull-right">  
			  <a class="btn btn-flat btn-default mr-5" href="/ekeuanganpts/index.php?mod=rencana_pencairan_dana&amp;sub=excelRencanaPencairanDana&amp;act=view&amp;typ=xlsx&amp;ta_id=9&amp;unit_id=1&amp;unit_nama=UNIVERSITAS&amp;ta_nama=2023" target="_blank" title="Cetak">
				 <i class="fa fa-file-excel-o"></i> Export Xls
			  </a>
			  <a class="btn btn-flat btn-default" href="javascript:void(0)" onclick="bukaPopupCetak('/ekeuanganpts/index.php?mod=rencana_pencairan_dana&amp;sub=cetakRencanaPencairanDana&amp;act=view&amp;typ=html&amp;ta_id=9&amp;unit_id=1&amp;unit_nama=UNIVERSITAS&amp;ta_nama=2023')" title="Cetak">
            ...
            <thead>
               ...
               <tbody>
                           ...
                           <tr class="table-common-even1" style="font-weight: bold;">
                              ...
                              <td style="text-align:right;">5.080.000</td>
		...
		<div class="panel-body">
            <div style="margin:10px 0px 0px 10px;font-weight:bold;color:#965F11;text-transform: uppercase">
               ...
               <div style="margin:10px 0px 0px 10px;font-weight:bold;color:#965F11">
                  <div style="padding:0px; margin:1px 5px 0px 0px; width:10px; height:10px; background-color:#FFFBDD; border:#D1C698 1px solid; float: left;">    </div> = Output
               </div>
               <div style="margin:10px 0px 0px 10px;font-style:italic;color:#965F11">
                  <div style="padding:0px; margin:1px 5px 0px 0px; width:10px; height:10px; background-color:#FFFDEF; border:#D1C698 1px solid; float: left;">    </div> = Komponen
               </div>
               <div style="margin:10px 0px 0px 10px;">
                  <div style="padding:0px; margin:1px 5px 0px 0px; width:10px; height:10px; background-color:#FFFFFF; border:#D1C698 1px solid; float: left;">    </div> = Rincian Belanja
               </div>
               <div style="margin:10px 0px 0px 10px;">
                  [ ] = Nama dalam RKAKL
               </div>
