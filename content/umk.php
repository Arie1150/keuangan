...
<ol class="breadcrumb page-breadcrumb">
    ...
    <li><a class="xhr dest_subcontent-element active" href="/ekeuanganpts/index.php?mod=finansi_jurnal_umk&amp;sub=AddJurnalUmk&amp;act=view&amp;typ=html">UMK &amp; Perjalanan Dinas</a></li>
...
<div class="page-header">
	<h1>
        <span class="text-muted font-weight-light">
			<i class="page-header-icon "></i> UMK &amp; Perjalanan Dinas
        </span>
    </h1>
</div>
   ...
   <div class="panel-body">
      ...
      <div class="btn-toolbar mb-15">
         <div class="btn-group pull-right"> 
            <a class="xhr dest_subcontent-element btn btn-default btn-flat" href="/ekeuanganpts/index.php?mod=finansi_jurnal_umk&amp;sub=JurnalUmk&amp;act=view&amp;typ=html" title="Daftar Jurnal Umum">
               <i class="fa fa-list-alt"></i> List Jurnal
            </a>
         </div>
      </div>

      <form method="POST" name="frmInputAp" action="/ekeuanganpts/index.php?mod=finansi_jurnal_umk&amp;sub=SaveJurnalUmk&amp;act=do&amp;typ=json" class="xhr_form form-horizontal dest_subcontent-element" data-target="/ekeuanganpts/index.php?mod=finansi_jurnal_umk&amp;sub=JurnalUmk&amp;act=view&amp;typ=html" id="frmInputAp">
         ...
         <div class="form-group">
            ...
            <div class="col-md-4">         
               <div class="input-group">
                  ...
                  <input type="text" name="peng_real_no_pengajuan" id="peng_real_no_pengajuan" size="40" value="" readonly="" class="form-control">
                  <span class="input-group-btn">
                     <button type="button" class="btn btn-default" onclick="javascript:bukaPopupUMK('/ekeuanganpts/index.php?mod=finansi_jurnal_umk&amp;sub=PopupSP3&amp;act=view&amp;typ=html', 'SP3', 800, 500);">
         ...
         <div class="panel panel-default">
            ...
            <div class="panel-body">                       
               <div class="btn-toolbar mb-15">
                  <div class="btn-group pull-right">
                     <a class="dest_subcontent-element btn btn-primary" href="javascript:void(0)" onclick="javascript:showPopup('/ekeuanganpts/index.php?mod=finansi_jurnal_umk&amp;sub=PopupCoa&amp;act=view&amp;typ=html&amp;tipe=debet','Chart Of Account',600, 500);" title="Tambah">
...
document.getElementById('CoaPlaceHolder_jurnal').addItem     = function(index,prk_id, id,kode, nama, subAkun,j_pajak, keterangan, nominal_d, nominal_k){   
   ...
   //untuk hidden tombol hapus, jika coa berasal dari  SP3
   //if( prk_id === '0' ) {
...
function bukaUnitKerja(xurl) {
    showPopup(xurl,'',600, 500);
}

function bukaPopupUMK(xurl) {
    showPopup(xurl ,'',600, 500);
}
</script>
