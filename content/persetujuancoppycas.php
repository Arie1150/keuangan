...
<ol class="breadcrumb page-breadcrumb">
    ...
    <li><a class="xhr dest_subcontent-element active" href="/ekeuanganpts/index.php?mod=finansi_pettycash_approval&amp;sub=PettycashApproval&amp;act=view&amp;typ=html">Persetujuan Petty Cash</a></li>
...
<div class="page-header">
	<h1>
        <span class="text-muted font-weight-light">
			<i class="page-header-icon "></i> Persetujuan Petty Cash
        </span>
    </h1>
</div>
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <form method="POST" name="filterbox" action="/ekeuanganpts/index.php?mod=finansi_pettycash_approval&amp;sub=PettycashApproval&amp;act=view&amp;typ=html" class="dataquest xhr_simple_form dest_subcontent-element form-horizontal" id="filterbox">
            <div class="row">
...
<div class="panel panel-default panel-petunjuk">
    ...
    <div class="panel-body">
        <ul>
            ...
            <li>
                Klik  <button type="button" class="btn btn-xs btn-success"><i class="fa fa-check-square"></i></button> Untuk Melakukan Approval
            </li>
        </ul>
    </div>
</div>
